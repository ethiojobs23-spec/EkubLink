  ...
  <div class="app-layout">
    ...
    <aside class="sidebar">
      <div class="sidebar-logo">
        ...
        <div style="margin-top:4px;font-size:0.75rem;color:var(--c-gold)">Collector Portal</div>
      </div>
      <nav class="sidebar-nav">
        <RouterLink to="/collector/dashboard" class="nav-item" active-class="active">
          <span class="nav-icon">📊</span> Dashboard
        </RouterLink>
        <RouterLink to="/collector/groups/create" class="nav-item" active-class="active">
          <span class="nav-icon">➕</span> New Ekub Group
        </RouterLink>
      </nav>
